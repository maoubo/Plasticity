...
class PPO(object):
                        ...
                        for i in range(self.args.num_envs):
                            ...
                            if not continue_inject:
                                performance_backdoor[backdoor_type] = \
                                    self.args.gamma * performance_backdoor[backdoor_type] + (1 - self.args.gamma) * judge[i]
                                judge[i] = 1  # reset
    ...
    def attack_judgement(self, backdoor_type, trigger_type, continue_inject):
        ...
        if self.args.poisoning_factor > 0.0:
            self.attack = True

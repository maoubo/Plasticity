...
def parse_args():
    ...
    parser.add_argument("--backdoor-method", type=int, default=1,
                        help="1：action tampering + reward hacking 2：only reward hacking")
...
if __name__ == "__main__":
    ...
    if args.load_agent:
        args.folders_dir = "./results/{}_({})_({})_seed{}".format(args.reward_hacking_method,
                                                                  args.plasticity_agent,
                                                                  args.plasticity_method,
                                                                  args.seed)
    else:
        args.folders_dir = "./results/{}_{}_seed{}".format(args.reward_hacking_method,
                                                           args.plasticity_method,
                                                           args.seed)
